...
class GelfHandler extends AbstractProcessingHandler
{
     ...
     * @param string $contextPrefix a string to prefix for all the 'context' fields from a Monolog record
     */
    public function __construct(MessagePublisher $publisher, $systemName = null, $level = Logger::DEBUG, $bubble = true, $extraPrefix = null, $contextPrefix = 'ctxt_')
    {
